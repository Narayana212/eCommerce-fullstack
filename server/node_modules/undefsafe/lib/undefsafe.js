...
/**
 * Safely access or set nested properties of an object using a dot-notated or bracket-notated string path.
 * @param {Object|Array} obj - The object or array to traverse.
 * @param {string} path - The path to the desired property, using dot notation or bracket notation.
 * @param {*} [value] - Optional value to set at the specified path.
 * @param {Array} [__res] - Internal parameter used for recursion when handling wildcard '*' paths.
 * @returns {*} The value at the specified path, undefined if the path doesn't exist, or the modified object if setting a value.
 */
function undefsafe(obj, path, value, __res) {
  ...
  var star =
    /**
     * Checks if the 'parts' array contains at least one asterisk ('*') element
     * @param {Array} parts - An array of elements to be checked
     * @returns {boolean} True if the array contains at least one asterisk, false otherwise
     */
